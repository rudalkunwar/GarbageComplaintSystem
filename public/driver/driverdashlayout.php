    ...
    <div class="fixed h-screen flex flex-col w-14 hover:w-64 md:w-64 bg-violet-500 text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
            ...
            <ul class="flex flex-col mt-20 py-4 space-y-1">
                ...
                <li>
                    <a href="dlogout.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-gray-800 pr-6" onClick="return confirm('Do you want to Logout ?')">
                        <span class="inline-flex justify-center items-center ml-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
