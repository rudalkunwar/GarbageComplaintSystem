    ...
    <div class="h-full w-full p-5 ml-14 md:ml-64 ">
        ...
        <div class="container max-w-full px-4 mx-auto sm:px-8">
            ...
            <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div id="popupForm" class="hidden w-96 h-full bg-violet-200 rounded-md shadow-lg">
                    <div class="px-10 py-5 w-full ">
                        ...
                        <form method="POST" action="updatecomplain.php">
                            ...
                            <div class="my-4">
                                ...
                                <textarea name="description" id="updateMessage" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500" rows="6"></textarea>
                            </div>
