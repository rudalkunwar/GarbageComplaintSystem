        ...
        <div class="fixed h-screen flex flex-col w-14 hover:w-64 md:w-64 bg-sky-600 text-white transition-all duration-300 border-none z-10 sidebar">
            <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <div class="fixed w-full flex items-center h-14 text-white z-10">
                    <div class="flex items-center justify-start  pl-3 w-14 md:w-64 h-14 bg-red-400 border-none">
                        <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="../images/rudal.png" />
                        <span class="hidden md:block">Rudal Kunwar</span>
                    </div>
                </div>
