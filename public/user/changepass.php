            ...
            <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                <form name="form" class="px-8 pt-2 pb-8 mb-4 bg-white rounded" method="post" action="" onsubmit="return validate();">
                    ...
                    <div class="mb-6 text-center">
                        <input type="submit" value="Update Password" class="btn w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full hover:bg-blue-700" name="updatepass" onclick="return confirm('Are you sure want to change password ?');">
                    </div>
                </form>
            </div>
