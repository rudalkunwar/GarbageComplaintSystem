...
<body>
    ...
    <main class="flex-1 p-6">
            <h1 class="text-2xl font-bold mb-6">Welcome, <?php //echo "$user"?></h1>
            ...
            <div class="flex">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div class="bg-white rounded-lg shadow-md p-6 hover:bg-red-100">
                        <h2 class="text-lg font-semibold mb-4">Submited Complains</h2>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div class="bg-white rounded-lg shadow-md p-6 hover:bg-green-100">
                        <h2 class="text-lg font-semibold mb-4">Accepted Complains</h2>
                        <div class="flex justify-between">
                            <div class="text-gray-500">Total</div>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div class="bg-white rounded-lg shadow-md p-6 hover:bg-gray-200">
                        <h2 class="text-lg font-semibold mb-4">Rejected Complains</h2>
                        <div class="flex justify-between">
                            <div class="text-gray-500">Total</div>
